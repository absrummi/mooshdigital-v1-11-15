...
<body>
      ...
      <div class="my-header e-commerce-PK">
            <div class="">
                    <nav class="navbar navbar-inverse">
                            ...
                            <div class="wrapper-content">
                                  <div class=" ">
                                          <div class="navbar-header">
											  <p id="menu_tag" style="color: white;position: absolute;top: 47px;right: 21px;font-size: 13px;z-index: 0;">MENU</p>
												<style>
                            ...
                            <!-- <p class="headingB">User Experience<br/> Design</p> -->
                            <!-- <p class="descriptionB">Freelance Web Designer & Developer based in UK,London.<br/> Highly experienced in designing & developing custom Wordpress websites. </p> -->
		  ...
		  <div id="go_top">
    <button onclick="topFunction()" id="go_top_Btn" title="Go to top"><img class="img-responsive" src="" width="60" height="60"></button>
</div>